...
def override_dependencies(monkeypatch):
    monkeypatch.setattr("app.dependencies.get_database_service", lambda: mock_database_service)
    monkeypatch.setattr("app.dependencies.get_storage_service", lambda: mock_storage_service)
    return True
